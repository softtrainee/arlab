...
# from traitsui.api import View, Item, UItem, TabularEditor, VSplit, VGroup, HGroup, HSplit
# from src.database.isotope_analysis.summary import Summary, \
#    TextTable, TextRow, TextCell, BoldCell, TextTableAdapter
...
#                                for ri in sg]
#                   )
# #        print len(rs[0].cells)
# #        print len(rs[1].cells)
#
#        tt = TextTable(
#                       *rs
#                       )
