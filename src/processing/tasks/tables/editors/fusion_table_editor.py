...
from src.processing.tables.fusion.csv_writer import FusionTableCSVWriter
from src.processing.tables.fusion.pdf_writer import FusionTablePDFWriter
from src.processing.tables.fusion.xls_writer import FusionTableXLSWriter
from src.processing.tasks.tables.editors.arar_table_editor import ArArTableEditor
from src.processing.tasks.tables.editors.adapters import FusionTableAdapter, \
...
class FusionTableEditor(ArArTableEditor):
    ...
    mean_adapter_klass = FusionTableMeanAdapter
...
#        ans = self._clean_items()
#        means = self.means
#        from src.processing.tables.fusion.xls_writer import LaserTableXLSWriter
#
...
#        ans = self._clean_items()
#        means = self.means
#        from src.processing.tables.fusion.csv_writer import LaserTableCSVWriter
#
