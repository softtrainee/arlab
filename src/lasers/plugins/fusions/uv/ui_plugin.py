...
UV_PROTOCOL = 'src.lasers.laser_managers.fusions_uv_manager.FusionsUVManager'

class FusionsUVUIPlugin(FusionsLaserUIPlugin):
    name = 'uv'
    id = 'fusions.uv'
    _protocol = UV_PROTOCOL
...
#        '''
#        action_sets = []
#        diode = self.application.get_service(UV_PROTOCOL)
#        if diode:
...
#        return self._create_stage_manager_view(UV_PROTOCOL, 'stage', **kw)
#
#    def create_diode_view(self, **kw):
#        return self._create_laser_manager_view(UV_PROTOCOL, 'laser_control', **kw)
#
#
