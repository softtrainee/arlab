...
from src.entry.tasks.actions import SaveLabbookPDFAction, MakeIrradiationTemplateAction, LabnumberEntryAction, SensitivityEntryAction
...
class EntryPlugin(BaseTaskPlugin):
    ...
    def _labnumber_entry_task_factory(self):
        from src.entry.tasks.labnumber_entry_task import LabnumberEntryTask

        return LabnumberEntryTask()

    def _sensitivity_entry_task_factory(self):
        from src.entry.tasks.sensitivity_entry_task import SensitivityEntryTask
