...
from traits.api import HasTraits, Property, Str, cached_property, \
    List, on_trait_change, Int, Bool, Event
...
class RunIDEntry(Loggable):
    ...
    def traits_view(self):
        ...
        auto = Group(
                    Item('auto_assign', label='Auto-assign RunIDs'),
                    Item('auto_startrid', label='Start RunID Number',
                    ...
                    Item('auto_assign_overwrite', label='Overwrite exisiting RunIDs',
                         enabled_when='auto_assign'
                         ),
                      show_border=True,
                      label='Auto-Assign'
...
#    def _irradiation_tray_changed(self):
