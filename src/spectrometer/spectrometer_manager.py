...
#    scan_manager = Instance(ScanManager)
#    ion_optics_manager = Instance(IonOpticsManager)
#
#    def _ion_optics_manager(self):
#        return IonOpticsManager(spectrometer=self.spectrometer)
#
#    def _scan_manager_default(self):
#        return ScanManager(spectrometer=self.spectrometer)
